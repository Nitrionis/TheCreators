...
void main() {
    out_color_0 =
          texture(texSampler, uv_0 - pixelSize[0] * 5) * coeffs[0]
        + texture(texSampler, uv_0 - pixelSize[0] * 4) * coeffs[1]
        + texture(texSampler, uv_0 - pixelSize[0] * 3) * coeffs[2]
        + texture(texSampler, uv_0 - pixelSize[0] * 2) * coeffs[3]
        + texture(texSampler, uv_0 - pixelSize[0]) * coeffs[4]
